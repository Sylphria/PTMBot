...
\n*TOT ศทก. 022051313";				
		...
		$regex = '/^(bot|บอท){1,1}$/i';
		if(preg_match($regex ,$text)){	
			$arr_hint=array('มีอะไรให้ช่วยครับ','ว่าไงครับ','บอทเป็นระบบอัตโนมัติไม่สามรถตอบคำถามตรงๆได้ครับ','สวัสดีครับ บอทรุ่นใหม่ไม่เหวี่ยง แต่กวนๆนิดหน่อย?','ถามอะไรตอบได้ ถามมากๆตอบไม่ไหวครับ');
