...
";				
	...
	,'/เข้าระบบ.{0,20}SSLVPN.{0,20}ไม่ได้/i'
		...
		foreach($regex as $reg){
			if(preg_match($reg ,$text)){
				$is_match=true;
$hint = "SSL VPN เป็นช่่องทางพิเศษ เพื่อเข้าใช้งานระบบสารสนเทศตร.ผ่านอินเทอร์เน็ต จะทำให้ท่านทำงานได้จากทุกๆที่
...
เพื่อใช้ในการเข้าสู่ระบบในโปรแกรม Global Protect ได้ที่ http://118.175.46.5 หรือ www.sslvpn.police.go.th
